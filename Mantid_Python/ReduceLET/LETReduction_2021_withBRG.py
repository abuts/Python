...
#------------------------------------------------------------------------------------#++++++
    ...
    def def_main_properties(self):
        ...
        prop = {}
#---------------------------------------------------------------------------#
        prop['incident_energy']     = [3.7]
        prop['energy_bins']         = [-0.8,0.0025,0.8]
        prop['sample_run']          = 73024
        prop['wb_run']              = 73023
        prop['empty_bg_run']        = None
        prop['empty_bg_run_for_wb'] = 73020
...
#------------------------------------------------------------------------------------#
    ...
    def def_advanced_properties(self):
      ...
      prop['hardmaskOnly']=None #'mask_211.xml' # Use diag (hardmaskPlus option) to enhance hard masks
...
#------------------------------------------------------------------------------------#
    ...
    def set_custom_output_filename(self):
        ...
        def custom_name(prop_man):
            ...
            if prop_man.empty_bg_run is None:
                bgtype = ''
            else:
                bgtype = '_{0}'.format(prop_man.empty_bg_run)

            if prop_man.empty_bg_run_for_wb is None:
                wbtype = ''
            else:
                wbtype = '_{0}'.format(prop_man.empty_bg_run_for_wb)
            ...
            name = "LET{0}_{1:<3.2f}meV{2}{3}".format(run_num,ei,bgtype,wbtype)
            return name
