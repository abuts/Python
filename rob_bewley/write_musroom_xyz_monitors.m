function fh_out = write_musroom_xyz_monitors(neutronic_pos_info,mon_file_name)
...
neutronic_dat   =sprintf('       <neutronic x=\"%f\" y=\"%d\" z=\"%f\" type = \"bead\" />\n',neutr_pos(3),neutr_pos(4),neutr_pos(5));
