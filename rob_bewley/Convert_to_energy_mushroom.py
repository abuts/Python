...
data_file = os.path.join(wk_folder,'mccode2De.h5')
...
ConvertUnits(InputWorkspace='EventData_mccode', OutputWorkspace='EventData_mccodeE', Target='DeltaE', EMode='Indirect', AlignBins=True, ConvertFromPointData=True)
Rebin(InputWorkspace='EventData_mccodeE', OutputWorkspace='EventData_mccodeE', Params='-0.2,0.06,6', IgnoreBinErrors=True)
SaveNXSPE('EventData_mccodeE','dE2_test.nxspe')
